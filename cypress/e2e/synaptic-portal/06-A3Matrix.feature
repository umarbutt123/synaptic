Feature: 06- A3Matrix Feature
    ...
    Scenario Outline: User should be able to add A3 Matrix
        ...
        Examples:
            ...
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "Automated Strategic Objectives1" | "Adding Automated Strategic Objectives description" |
    ...
    Scenario Outline: User should be able to see all charts added in A3 Matrix
        ...
        Examples:
            ...
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Current Conditions" | "Implementation" | "Root Cause Analysis" | "Target Conditions/Future States" | "Evaluation" | "Suggested Actions" | "Follow-up" |
    ...
    Scenario Outline: User should be able to add current status in Current condition chart
        ...
        And I navigate to the A3-Matrix page
        And I click on A3-Matrix <TITLE>
        And I click add new objective button on "Current Conditions" chart
    ...
    Scenario Outline: User should be able to add Actions in Implementation chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text1"     |
    ...
    Scenario Outline: User should be able to add Analysis in Root Cause Analysis chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text2 "    |
    ...
    Scenario Outline: User should be able to add Tools Used in Root Cause Analysis chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text3"     |
    ...
    Scenario Outline: User should be able to add Goals Used in Target Condition/Future State chart
        ...
        And I navigate to the A3-Matrix page
        And I click on A3-Matrix <TITLE>
        And I click add new objective button on "Target Conditions/Future States" chart
        And I add new "Goals:" with following title <CURRENT_STATUS_TITLE>
        Then I validate success message "Changes updated successfully"
        Then I logout
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text4"     |
    ...
    Scenario Outline: User should be able to add SuggestedActions Used in Suggested Actions chart
        ...
        And I add new "Suggested Actions:" with following title <CURRENT_STATUS_TITLE>
        Then I validate success message "Changes updated successfully"
        Then I logout
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text5"     |
    ...
    Scenario Outline: User should be able to add Post-Implementation Checks Used in Evaluation chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text6"     |
    ...
    Scenario Outline: User should be able to add Actions to Sustain Improvements Used in Follow-up chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | CURRENT_STATUS_TITLE |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | "Test Add Text7"     |
    ...
    Scenario Outline: User should be able to edit Objective Used in Subject/Background chart
        ...
        Examples:
            ...
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text1 " |
    ...
    Scenario Outline: User should be able to edit Background Used in Subject/Background chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text2 " |
    ...
    Scenario Outline: User should be able to edit Significance Used in Subject/Background chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text3 " |
    ...
    Scenario Outline: User should be able to edit Current Status Used in Current Condition chart
        ...
        And I navigate to the A3-Matrix page
        And I click on A3-Matrix <TITLE>
        And I click on Edit button on "Current Conditions" chart
        And I add following <text> against "Current Status:" while editing
        Then I validate success message "Changes updated successfully"
        Then I logout
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text4 " |
    ...
    Scenario Outline: User should be able to edit Actions Used in Implementation chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text5 " |
    ...
    Scenario Outline: User should be able to edit Analysis Used in Root Cause Analysis chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text6 " |
    ...
    Scenario Outline: User should be able to edit Tools Used in Root Cause Analysis chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text7 " |
    ...
    Scenario Outline: User should be able to edit Goals Used in Target Condition/Future State chart
        ...
        And I navigate to the A3-Matrix page
        And I click on A3-Matrix <TITLE>
        And I click on Edit button on "Target Conditions/Future States" chart
        And I add following <text> against "Goals:" while editing
        Then I validate success message "Changes updated successfully"
        Then I logout
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text8 " |
    ...
    Scenario Outline: User should be able to edit SuggestedActions Used in Suggested Actions chart
        ...
        And I add following <text> against "Suggested Actions:" while editing
        Then I validate success message "Changes updated successfully"
        Then I logout
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text           |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text9 " |
    ...
    Scenario Outline: User should be able to edit Post-Implementation Checks Used in Evaluation chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text            |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text10 " |
    ...
    Scenario Outline: User should be able to edit Actions to Sustain Improvements Used in Follow-up chart
        ...
        Examples:
            | EMAIL                             | PASSWORD    | TITLE                                     | CHART_NAME           | text            |
            | "croubayinoulle-3277@yopmail.com" | "Test@1234" | "I want to increase profit of my company" | "Subject/Background" | " Edit Text11 " |
